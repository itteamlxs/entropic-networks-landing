...
<!-- Mirrored from themes.3rdwavemedia.com/tempo/bs5/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Dec 2025 21:28:25 GMT -->
    ...
    <div class="wrapper">
                    ...
                    <div class="navbar-collapse collapse justify-content-end" id="navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="active nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">Blog <i class="fa fa-angle-down"></i></a>
        ...
        <div class="blog container">
            ...
            <div class="row gx-lg-5 justify-content-lg-center">
                ...
                <div id="blog-list" class="blog-list section col-lg-7 col-12">
                    <article class="post">
                    ...
                    <article class="post">
                        ...
                        <div class="content">
                            ...
                            <div class="meta">
                                <ul class="meta-list list-inline">                                       
                                	<li class="list-inline-item post-time post_date date updated">16th May</li>
                                	<li class="list-inline-item post-author"> by <a href="#">Admin</a></li>
                                	<li class="list-inline-item post-comments-link">
                    ...
                    <article class="post">
                        ...
                        <div class="content">
                            ...
                            <div class="meta">
                                <ul class="meta-list list-inline">                                       
                                	<li class="list-inline-item post-time post_date date updated">22th April</li>
                                	<li class="list-inline-item post-author"> by <a href="#">Admin</a></li>
                                	<li class="list-inline-item post-comments-link">
                    ...
                    <article class="post">
                        ...
                        <div class="content">
                            ...
                            <div class="meta">
                                <ul class="meta-list list-inline">                                       
                                	<li class="list-inline-item post-time post_date date updated">12th April</li>
                                	<li class="list-inline-item post-author"> by <a href="#">Admin</a></li>
                                	<li class="list-inline-item post-comments-link">
                    ...
                    <article class="post">
                        ...
                        <div class="content">
                            ...
                            <div class="meta">
                                <ul class="meta-list list-inline">                                       
                                	<li class="list-inline-item post-time post_date date updated">3th April</li>
                                	<li class="list-inline-item post-author"> by <a href="#">Admin</a></li>
                                	<li class="list-inline-item post-comments-link">
                ...
                <aside id="blog-sidebar" class="blog-sidebar col-12 col-md-auto">
                    ...
                    <section class="widget recent-posts">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="#">Phasellus feugiat arcu eget sem tincidunt </a></li>
                            <li><a href="#">Pellentesque mattis scelerisque</a></li>
                            <li><a href="#">Nulla egestas commodo dignissim</a></li>
                        </ul>
                    </section><!--//widget-->
                </aside><!--//blog-side-bar-->               
            </div><!--//row-->
...
<!-- Mirrored from themes.3rdwavemedia.com/tempo/bs5/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Dec 2025 21:28:30 GMT -->
</html> 
