...
<!-- Mirrored from themes.3rdwavemedia.com/tempo/bs5/tour.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Dec 2025 21:28:14 GMT -->
            ...
            <div class="container position-relative">
                <div class="row gx-lg-5">
                    <div class="features-intro col-lg-6 col-md-7 col-12 position-relative pl-md-5">
                        <h2 class="title">Take a quick tour<br />to see how it works</h2>
                        <ul class="list-unstyled features-list">
                            <li><i class="fas fa-check"></i>Feature one consectetur neque ultrices</li>
                            <li><i class="fas fa-check"></i>Feature two sit amet lacus tincidunt</li>
                            <li><i class="fas fa-check"></i>Feature three sed tincidunt tortor</li>
                            <li><i class="fas fa-check"></i>Feature four ipsum dolor sit amet</li>
                            <li><i class="fas fa-check"></i>Feature five purus imperdiet</li>
                        </ul>
                    </div><!--//intro-->
                    <div class="features-video col-lg-6 col-md-5 col-12 pr-0 pr-md-5">
                        <div class="ratio ratio-16x9">
                            <iframe src="https://player.vimeo.com/video/28872840" width="720" height="405" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>               
                        </div><!--//video-container-->  
                    </div><!--//video-->
                </div><!--//row-->
            </div><!--//container-->
            ...
            <div class="container">
                ...
                <div class="item row gx-5">
                    <div class="content col-md-5 col-12">
                        <h3 class="title">Feature two sit amet lacus</h3>
                        <div class="details">
                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin lobortis mattis erat, dictum facilisis magna posuere ac. Curabitur consectetur magna mauris, et aliquam lectus ornare nec. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Mauris quis tellus magna.</p>
                        </div>
                    </div><!--//content-->
                    <div class="figure col-md-6 col-12 ml-md-auto">
                        <img class="img-fluid" src="assets/images/features/product-2.png" alt="" />
                    </div><!--//figure-->
                </div><!--//item-->
                ...
                <div class="item row gx-5">
                    <div class="col-md-5 col-12 order-md-5 ml-md-auto">
                        <h3 class="title">Feature three sed tincidunt tortor</h3>
                        <div class="details">
                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin lobortis mattis erat, dictum facilisis magna posuere ac. Curabitur consectetur magna mauris, et aliquam lectus ornare nec. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Mauris quis tellus magna.</p>
                        </div>
                    </div><!--//content-->
                    <div class="figure col-md-6 col-12 order-md-1">
                        <img class="img-fluid" src="assets/images/features/product-3.png" alt="" />
                    </div><!--//figure-->
                </div><!--//item-->
                ...
                <div class="item row gx-5">
                    <div class="content col-md-5 col-12">
                        <h3 class="title">Feature four ipsum dolor sit amet</h3>
                        <div class="details">
                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin lobortis mattis erat, dictum facilisis magna posuere ac. Curabitur consectetur magna mauris, et aliquam lectus ornare nec. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Mauris quis tellus magna.</p>
                        </div>
                    </div><!--//content-->
                    <div class="figure col-md-6 col-12 ml-md-auto">
                        <img class="img-fluid" src="assets/images/features/product-4.png" alt="" />
                    </div><!--//figure-->
                </div><!--//item-->
...
<!-- Mirrored from themes.3rdwavemedia.com/tempo/bs5/tour.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Dec 2025 21:28:18 GMT -->
</html> 
