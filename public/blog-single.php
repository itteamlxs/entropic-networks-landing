...
<!-- Mirrored from themes.3rdwavemedia.com/tempo/bs5/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Dec 2025 21:28:30 GMT -->
...
<body class="blog-single-page">    
    <div class="wrapper">
                    ...
                    <div class="navbar-collapse collapse justify-content-end" id="navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle active" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">Blog <i class="fas fa-angle-down"></i></a>
        ...
        <div class="blog container">            
            <div class="row gx-lg-5 justify-content-lg-center">
                <div id="blog-entry" class="blog-entry section col-lg-7 col-12">                 
                    <article class="post">
                        <h2 class="title">Aenean erat lorem, molestie non ornare eu</h2>
                        <div class="meta">
                            <ul class="meta-list list-inline">                                       
                            	<li class="list-inline-item post-time post_date date updated">25th May</li>
                        ...
                        <div class="content">
                            ...
                            <p class="video-container ratio ratio-16x9">
                            <iframe src="http://player.vimeo.com/video/50134267?color=ffffff&amp;wmode=transparent" width="720" height="405" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                            </p>
                            ...
                            <blockquote class="custom-quote">
                                ...
                                <p class="source"><span class="name">James Turner</span><br><span class="title">London, UK</span></p>
                            </blockquote>
                ...
                <aside id="blog-sidebar" class="blog-sidebar col-12 col-md-auto">
                    ...
                    <section class="widget social">
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item"><a href="#"><i class="fa-brands fa-facebook-square"></i></a></li>
                    ...
                    <section class="widget archives">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="#">June 2023 <span class="count">(3)</span></a></li>
                            <li><a href="#">May 2023 <span class="count">(5)</span></a></li>
                            <li><a href="#">April 2023 <span class="count">(4)</span></a></li>
                            <li><a href="#">March 2023 <span class="count">(2)</span></a></li>
                        </ul>
                    </section><!--//widget-->
                    <section class="widget recent-posts">
                        <h3 class="title">Recent Posts</h3>
                        <ul class="list-unstyled">
                            <li><a href="#">Lorem ipsum dolor sit amet</a><br /><span class="date">22 May 2023</span></li>
                            <li><a href="#">Vestibulum ante ipsum primis</a><br /><span class="date">16 May 2023</span></li>
                            <li><a href="#">Phasellus feugiat arcu eget sem tincidunt </a><br /><span class="date">12 May 2023</span></li>
                            <li><a href="#">Pellentesque mattis scelerisque</a><br /><span class="date">27 April 2023</span></li>
                            <li><a href="#">Nulla egestas commodo dignissim</a><br /><span class="date">6 April 2023</span></li>
                        </ul>
                    </section><!--//widget-->
                </aside><!--//blog-side-bar-->               
            </div><!--//row-->
