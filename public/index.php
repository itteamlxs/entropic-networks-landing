...
<head>
	<title>Entropic Networks - Technology in Balance</title>
	<!-- Meta -->
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="Entropic Networks transforms technological chaos into competitive advantage. Comprehensive IT solutions with personalized and preventive approach.">
	<meta name="author" content="Entropic Networks">
	...
	<div class="wrapper">
		...
		<header id="header" class="header">
			<div class="container">
				<h1 class="logo">
					<a href="index.html">
						<span class="logo-title">Entropic Networks</span>
					</a>
				</h1><!--//logo-->
				<nav class="main-nav navbar navbar-expand-md navbar-dark" role="navigation">
					...
					<div class="navbar-collapse collapse justify-content-end" id="navbar-collapse">
						<ul class="nav navbar-nav">
							...
							<li class="nav-item"><a class="nav-link" href="tour.html">Services</a></li>
							<li class="nav-item"><a class="nav-link" href="pricing.html">Plans</a></li>
		...
		<section id="promo" class="promo section">
			<div class="container intro">
				<h2 class="title">Everything you need<br />to transform technological chaos into competitive advantage</h2>
				<p class="summary">Entropic Networks offers comprehensive technological solutions that optimize system performance and protect critical information with a preventive, personalized, and professional approach.</p>
				<a class="btn btn-cta btn-cta-secondary" href="tour.html">Our Services</a>
			</div><!--//intro-->

			<div class="fixed-container">
				<div class="signup">
					<div class="container text-center">
						<h3 class="title">Try Entropic Networks Free</h3>
						<p class="summary">Sign up to try our Basic Plan FREE for 30 days! No credit card needed.</p>
		...
		<section id="why" class="why section">
			<div class="container">
				<h2 class="title text-center">Why Choose Entropic Networks</h2>
				<p class="intro text-center">More than 300,000 satisfied customers trust our technological solutions worldwide</p>
				<div class="row">
					<div class="benefits col-lg-7 col-md-6 col-12">
						<div class="item">
							...
							<div class="content">
								<h3 class="title">All-in-One Technology Solution</h3>
								<p class="desc">We provide a complete range of services — specialized maintenance, network configuration, advanced cybersecurity, and consulting — in a single provider, eliminating the need for multiple partners and ensuring coherence and efficiency.</p>
							</div><!--//content-->
						</div><!--//item-->
						<div class="item">
							<div class="icon text-center">
							...
							<div class="content">
								<h3 class="title">Custom-Tailored Solutions</h3>
								<p class="desc">We design specific solutions for each client's unique needs, offering adapted strategies and services that optimize their systems and resolve their particular challenges.</p>
							</div><!--//content-->
						</div><!--//item-->
						<div class="item">
							<div class="icon text-center">
							...
							<div class="content">
								<h3 class="title">Preventive and Strategic Approach</h3>
								<p class="desc">We prioritize problem prevention and system optimization, distinguishing ourselves from reactive competitors by anticipating technological needs and proactively protecting our clients.</p>
							</div><!--//content-->
						</div><!--//item-->
						<div class="item">
							<div class="icon text-center">
							...
							<div class="content">
								<h3 class="title">Specialized Maintenance</h3>
								<p class="desc">We ensure your PCs and laptops operate in perfect condition, optimizing both hardware and software to extend their useful life and maximize their performance.</p>
							</div><!--//content-->
						</div><!--//item-->
						<div class="item last">
							<div class="icon text-center">
							...
							<div class="content">
								<h3 class="title">Cybersecurity and Consulting</h3>
								<p class="desc">We protect your data and systems through innovative solutions that anticipate threats and reduce vulnerabilities, ensuring the security of your critical information.</p>
							</div><!--//content-->
						</div><!--//item-->
						<div class="clearfix"></div>
						<div class="text-center">
							<a class="btn btn-cta btn-cta-secondary" href="tour.html" >Explore Our Services</a>
						</div>
					</div>
		...
		<section id="video" class="video section">
			<div class="container">
				<h2 class="title">Grow your business with technology in balance!</h2>
				<p class="summary">Discover how Entropic Networks can transform your technological challenges into effective solutions that drive your company's productivity.</p>
		...
		<section id="signup" class="signup">
			<div class="container text-center">
				<h2 class="title">Ready to bring technology in balance with Entropic Networks?</h2>
				<p class="summary">Sign up to try our Basic Plan FREE for 30 days! No credit card needed.</p>
					...
					<div class="col-lg-6 col-12">
						<div class="footer-col about">
							<div class="footer-col-inner">
								<h3 class="title">About Entropic Networks</h3>
								<p>At Entropic Networks, we specialize in providing a comprehensive range of technological services designed to ensure optimal performance of your equipment and systems. Our purpose is to transform technological challenges into effective solutions that drive productivity and protect your investment.</p>
							...
							<div class="footer-col col-12 col-lg-6 contact">
								<div class="footer-col-inner">
									...
									<div class="row">
										...
										<p class="email col-lg-12 col-md-4 col-12"><i class="fas fa-envelope"></i><a href="#">support@entropicnetworks.com</a></p>
